...
UMKM_KNOWLEDGE = {
    "nib": (
        ...
        "📄 <strong>Persyaratan NIB (Nomor Induk Berusaha):</strong><br>" 
    ...
    "kbli_info": (
        ...
        "KBLI ini wajib dicantumkan saat pelaku usaha mendaftarkan NIB (Nomor Induk Berusaha) melalui sistem OSS (Online Single Submission).<br><br>" 
        "<strong>Fungsi KBLI dalam pengajuan NIB:</strong><br>" 
        "• Menentukan jenis usaha yang dijalankan pelaku usaha.<br>" 
        "• Menjadi dasar penentuan perizinan berusaha dan kewajiban lainnya.<br>" 
        ...
        "<strong>Kode terdiri dari 5 digit angka, contoh:</strong><br> \n"
            ...
            "• 74100 → Aktivitas Desain Spesialis\n\n"
        ...
        "• Jasa potong rambut: 96021<br><br>" 
        "🔍 <strong>Cara Mencari Kode KBLI:</strong><br>" 
        "Untuk mencari kode KBLI yang tepat, Anda bisa:<br><br>" 
        "<strong>1. Deskripsikan usaha Anda</strong><br>" 
        "- Ketik jenis usaha atau layanan yang Anda jalankan<br><br>" 
        "<strong>2. Contoh input yang baik:</strong><br>" 
        "• \"berikan kode kbli untuk warung makan nasi padang\"<br>" 
        "• \"berapa kode kbli untuk toko elektronik handphone\"<br>" 
        "• \"saya memiliki usaha jasa service motor\"<br>" 
        "• \"berikan kode kbli untuk klinik kesehatan umum\"<br><br>" 
